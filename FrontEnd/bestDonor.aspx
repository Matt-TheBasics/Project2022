<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bestDonor.aspx.cs" Inherits="CodingPackFrontRevised.bestDonor" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="bs-docs-example">
            ...
            <h3 style="text-align: center; color: tomato">Best Donor</h3>
            ...
            <asp:Button ID="back" runat="server" Text="Back" class="btn" OnClick="back_Click" Style="width: 200px; height: 40px; margin-left: 13px;" />
    </form>
</body>
</html>
