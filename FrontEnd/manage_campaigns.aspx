<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manage_campaigns.aspx.cs" Inherits="CodingPackFrontRevised.manage_campaigns" %>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="campaignmanagement.aspx" class="nav-item nav-link">Campaigns</a>
    ...
    <form id="form1" runat="server">
        ...
        <div class="bs-docs-example">
            ...
            <br />
            <asp:Button ID="addCampaign" runat="server" Text="Add Campaign" class="btn" OnClick="addcampaign_Click" style="Height:40px; margin-left:13px;"  />
