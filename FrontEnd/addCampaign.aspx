<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addCampaign.aspx.cs" Inherits="CodingPackFrontRevised.addCampaign" %>
    ...
    <form id="form1" runat="server">
        <div class="container1">
            ...
            <div id="capturedetails" runat="server" visible="true">
                ...
                <br />
                <br />
                <asp:Button ID="regsubmit" runat="server" Text="Add" class="btn" OnClick="add_Click" Style="width: 400px; background-color: black; color: white;" />
            </div>
        </div>
    </form>
    <script>
